...
static  char *gettext (const char *__msgid)
{
...
static  char *dgettext (const char *__domainname, const char *__msgid)
{
...
extern LIBINTL_DLL_EXPORTED char *libintl_dcgettext (const char *__domainname, const char *__msgid,
				int __category);
static  char *dcgettext (const char *__domainname, const char *__msgid,
			       int __category)
{
...
static  char *ngettext (const char *__msgid1, const char *__msgid2,
			      unsigned long int __n)
{
...
static  char *dngettext (const char *__domainname, const char *__msgid1,
			       const char *__msgid2, unsigned long int __n)
{
...
static  char *dcngettext (const char *__domainname,
				const char *__msgid1, const char *__msgid2,
				unsigned long int __n, int __category)
{
...
static  char *textdomain (const char *__domainname)
{
...
static  char *bindtextdomain (const char *__domainname,
				    const char *__dirname)
{
...
static  char *bind_textdomain_codeset (const char *__domainname,
					     const char *__codeset)
{
