...
/* проверьте, существует ли каталог config; если нет, создайте его и установите config_dir */
void check_config_dir_name()
{
    struct stat info;
#ifndef INSTALLDIR
    /* если нет установки храните конфигурацию в текущем каталоге не дома */
...
/* установить конфиг по умолчанию */
void reset_config()
{
    /* опции gfx */
    config.tran = 1;
