...
enum {
    ...
    STATUS_MERGE,              /* человек может сливаться с партнерами */
...
/*
====================================================================
Deqeue следующее действие и выполнение его.
====================================================================
*/
...
static void engine_main_loop( int *reinit )
{
    ...
    if ( status == STATUS_TITLE && !term_game ) {
        ...
        engine_begin_turn( cur_player, setup.type == SETUP_LOAD_GAME /* пропустить подготовку юнита тогда */ );
    gui_get_bkgnds();
    *reinit = 0;
    reset_timer();
