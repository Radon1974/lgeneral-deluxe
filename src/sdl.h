...
typedef struct _Font {
    ...
    int         height;
    int         char_offset[256];
    int		width;	// общая ширина поверхности, * должно * следовать за char_offset
    			// потому что он используется для разлива char_offset
    char        keys[256];
    char        offset;
    char        length;
    //последний написанный прямоугольник
    int     	last_x;
    int         last_y;
    int	        last_width;
    int	        last_height;
