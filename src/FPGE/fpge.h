...
/*  -------------------- Вот главный диалог ----------------------- */
/* ------ в этом разделе определены основные диалоги ------------------- */
//#define SCREEN_X 640
//#define SCREEN_Y 480
...
//только основные цвета графического интерфейса
...
#define COST  41 //стоимость
#define BMP   42 //номер значка - 2 bytes
#define ANI   44 //номер анимации - 2 bytes (?)
#define MON   46
#define YR    47
#define LAST_YEAR 48
#define ALLOWED_TRANSPORT 49 //1 банку с органикой, 2 банки с воздухом, 3 банки с парашютом
