...
/*
====================================================================
Проверьте окружение плитки и примените к
ней функцию eval. Результаты могут храниться в контексте.
Если 'eval_func' возвращает False, то оценка разбивается.
====================================================================
*/
...
void ai_eval_hexes( int x, int y, int range, int(*eval_func)(int,int,void*), void *ctx )
{
    ...
    AI_Pos *pos;
    int i, nx, ny;
    /* соберите и обработайте все позиции широкий поиск.
       используйте AUX mask для пометки посещенных позиций */
