...
/*
====================================================================
Получить идентификатор нации (позиция в списке)
====================================================================
*/
...
Нарисуйте значок флага на поверхности.
  ...
  NATION_DRAW_FLAG_OBJ:    добавьте золотую рамку, чтобы отметить ее как военную
                           задачу
====================================================================
*/
