...
#define AT_RGB(pixel, idx) (((Uint8 *)&(pixel))+(idx))
     ...
     */
    {
         ...
         * 1. ‘оздайте новую поверхность, достаточно большую, чтобы вместить как сохраненные, так и новые глифы.
...
/*
====================================================================
‡апишите строку в x, y и измените y так, чтобы она отображалась в
следующаЯ строка.
====================================================================
*/
...
/** Џолучить список всех видеорежимов. ‚ыделите @vmi и верните количество
 * записи. */
...
/*
====================================================================
Џерейти в режим пропущенного видео.
====================================================================
*/
